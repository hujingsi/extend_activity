package com.example.lcjingsi.extend_activity;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragmentpreference);
        inview();
        setlistern();
    ...
    private void create_dialog_edit() {
        ...
        editdialog.setTitle("Enter your favourite animal");
    ...
    private void inview() {
        ...
        radio_group=getLayoutInflater().inflate(R.layout.activity_main,null);
